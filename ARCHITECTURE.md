...
│  │  └──────────────────────────────────────────┘ │   │
│  │  ┌──────────────────────────────────────────┐ │   │
│  │  │  Settings window (local React bundle)    │ │   │
│  │  │  preload IPC + file:// renderer          │ │   │
│  │  └──────────────────────────────────────────┘ │   │
│  └──────────────────────────────────────────────┘   │
│                                                      │
...
│   ├── settings-app.jsx     React source for the Settings window
│   ├── settings-renderer.js Bundled Settings renderer loaded by settings.html
│   └── menu.js              Application menu definition
├── scripts/
│   ├── build-settings-renderer.js Bundles the React Settings window
...
- **Settings panel**: migrate the remaining IPC/localStorage bridge to a shared
  React route inside the main app if we eventually want a single UI stack.
