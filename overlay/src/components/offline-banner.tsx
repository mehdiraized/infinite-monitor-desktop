...
export function OfflineBanner() {
  ...
  return (
    <div
      role="alert"
      className="fixed bottom-0 inset-x-0 flex items-center gap-2.5 px-5 py-2 bg-amber-950/90 border-t border-amber-800/60 text-amber-200 text-xs select-none z-50"
    >
